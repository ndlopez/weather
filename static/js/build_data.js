...
(async ()=>{
    ...
    text += `<div class="clearfix"><span class='large'>&emsp;${curr_weather[lastElm].temp}&#8451;</span><span id='now_weather' class='middle'></span><h4>Max ${gotMax}&#8451;&emsp;Min ${maxmin[1]}&#8451;</h4></div><div id="rainToday"></div>`;//prev ${maxmin[0]}
    ...
    const winDesc = document.createElement("span");
